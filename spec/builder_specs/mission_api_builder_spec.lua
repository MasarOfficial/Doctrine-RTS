...
describe("MissionApiBuilder", function()
    ...
    describe("module call tracking", function()
        ...
        it("records Objectives calls", function()
            ...
            api.Modules.Objectives.AddObjective("obj1", true)
            api.Modules.Objectives.HideObjective("obj1")
            api.Modules.Objectives.ActivateObjective("obj1")
            api.Modules.Objectives.CancelObjective("obj1")
            api.Modules.Objectives.FailObjective("obj1")
            api.Modules.Objectives.CompleteObjective("obj1")
            ...
            assert.are.equal("obj1", api.calls.addObjective[1].objectiveID)
            assert.is_true(api.calls.addObjective[1].optional)
            assert.are.equal("obj1", api.calls.hideObjective[1].objectiveID)
            assert.are.equal("obj1", api.calls.activateObjective[1].objectiveID)
            assert.are.equal("obj1", api.calls.cancelObjective[1].objectiveID)
            assert.are.equal("obj1", api.calls.failObjective[1].objectiveID)
        ...
        it("clears every tracked call list via clearCalls", function()
            ...
            api.Modules.Objectives.AddObjective("o", false)
            api.Modules.Objectives.HideObjective("o")
            api.Modules.Objectives.ActivateObjective("o")
            api.Modules.Objectives.CancelObjective("o")
            api.Modules.Objectives.FailObjective("o")
            api.Modules.Objectives.CompleteObjective("o")
            ...
            assert.are.equal(0, #api.calls.addObjective)
            assert.are.equal(0, #api.calls.hideObjective)
            assert.are.equal(0, #api.calls.activateObjective)
            assert.are.equal(0, #api.calls.cancelObjective)
            assert.are.equal(0, #api.calls.failObjective)
