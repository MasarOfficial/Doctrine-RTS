...
describe("mission_api.validation", function()
	...
	describe("ValidateReferences", function()
		...
		it("warns when a stage is neither the initial stage nor targeted by a ChangeStage action", function()
			...
			validation.ValidateReferences()
			assert.is_true(hasError("Stage is unreachable: not the initial stage, and no ChangeStage action targets it. Stage: orphanedStage"))
			assert.is_false(hasError("Stage is unreachable: not the initial stage, and no ChangeStage action targets it. Stage: startStage"))
