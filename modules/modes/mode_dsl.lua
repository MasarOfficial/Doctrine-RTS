--- The Main options panel is a WHITELIST: a mode shows exactly what it claims, so these
--- verbs are how a preset exposes the base rules of a match — at lobby defaults, unlocked.
