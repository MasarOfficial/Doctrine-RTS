--- Lazy mirrors of the module api: the imperative call fires only when the trigger does.
--- Takes the Team handle, not a raw allyTeam id, so the mission line reads as English.
