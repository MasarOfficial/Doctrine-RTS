--- Every hack from luarules/gadgets/game_end.lua is preserved on purpose; the end-condition
--- decision stays with the caller. Deps are injected so the machine specs under busted.
